...
This code is partly derived from the DEAP project. They retain copyright to 
their code. See https://github.com/DEAP/deap/blob/master/examples/gp/ant.py
...
This is the original working example for cyGOURGS. It runs the artificial ant 
problem, a classic genetic programming benchmark problem. It is a bit slow owing 
to the use of a database to which we save all results. This feature has been 
changed in the `symbolic_regression.py` code.

Usage can be found by running `python3 ant.py -h`
'''
...
if __name__ == "__main__":
    ...
    parser.add_argument("-cppimpl", help="should use cpp implementation of algorithms? (If True, use C++ implementation. Else if False, use pyGOURGS python implementation.)", type=str2bool, default=True)
    if len(sys.argv) < 2:
        parser.print_usage()
        sys.exit(1)
